...
> Note: If you’re upgrading from firmware version v1.0.0 to v1.1.0 or higher, you’ll need a one-time factory firmware installation because we’ve switched frameworks. After that, OTA updates will work again as usual.  
